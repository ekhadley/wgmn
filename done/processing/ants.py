...
class ant():
    ...
    def walk(self):
        if self.mode == 'search':
            ...
            best = Vector(0, 0, 100000000)
            neighbors = []
            
            neighbors.append(Vector(-1, -1))
            neighbors.append(Vector(-1, 0))
            neighbors.append(Vector(-1, 1))
            neighbors.append(Vector(0, 1))
            neighbors.append(Vector(0, -1))
            neighbors.append(Vector(1, -1))
            neighbors.append(Vector(1, 0))
            neighbors.append(Vector(1, 1))
            ...
            if random.randint(0, 100) > 80:
                step = Vector(best.x, best.y)
            else:
                step = Vector(random.randint(-1, 1), random.randint(-1, 1))    
...
class food():
    def __init__(self):
        ...
        self.pos = Vector(random.randint(10, 790), random.randint(10, 790))
