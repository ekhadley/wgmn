...
def send(ctrl):
    try:
        if ctrl in range(-40, -20):
            qaz.write(b'7')
        if ctrl in range(-30, -10):
            qaz.write(b'6')
        if ctrl in range(-20, 0):
            qaz.write(b'5')
        if ctrl in range(-10, 10):
            qaz.write(b'4')
        if ctrl in range(0, 20):
            qaz.write(b'3')
        if ctrl in range(10, 30):
            qaz.write(b'2')
        if ctrl in range(20, 40):
            qaz.write(b'1')
    except Exception:
        print('trasnfer failed :(')
